                                                    ...
                                                    <div className="career-boxInner">
                                                        <div className="d-flex justify-content-center career-upperbx">
                                                            ...
                                                            <div className="ms-3 flex-shrink-1">
                                                                <p className="career-name">{exam.exam_name}</p>
                                                        ...
                                                        <Link className="career-readmore-btn text-center" to={`/exam_details/${exam.exam_name}`}>Read More <img src={rightArrow} alt="" /></Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
