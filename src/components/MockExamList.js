...
const itemsName = [
  'UP Scholarships Last.1..',
  'UP Scholarships Last.1..2',
  'UP Scholarships Last.1..3',
  'UP Scholarships Last.1..4',
  'UP Scholarships Last.1..45',
];
const MockExamList = () => {
  return (
    <section class="">
        ...
        <div class="implink-slider-bx position-relative">
          <p>
            <CustomSwiper
              ...
              navigationPrev={'.implink-button-prev'}
              noOfSlidesPerView={4}
              isBreakPoint={true}
