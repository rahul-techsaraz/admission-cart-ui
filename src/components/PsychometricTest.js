          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              <div className="position-relative pe-md-5">
                <img
                  src={constants.images.PsychometricTest.PsychometricTestimg1}
            ...
            <div className="col-md-6">
              ...
              <Link to={'/quiz'} className="theme-btn black-btn">
                Get Started Now
              </Link>
            </div>
          </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-7">
              <div className="position-relative ps-md-5">
                <img
                  src={constants.images.PsychometricTest.PsychometricTestimg2}
                  className="img-fluid about-img1"
                  alt=""
                />
              </div>
                          ...
                          <div class="testimonials-box">
                            <div class="testi-content-box">
                              <p>
                                ...
                                exercitation ullamco laboris nisi ut. Lorem ipsum dolor sit amet Lorem ipsum dolor sit
                                amet.
                              </p>
                            </div>
                            <img
      ...
      <section className="choice-place-section section-padding">
        <div className="choice-place-innersection d-flex">
          ...
          <div className="choice-place-col2">
            ...
            <p>
              Eaconsectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
              ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Culpa
