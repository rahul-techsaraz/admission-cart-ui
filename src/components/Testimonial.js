...
const testimonialPersonDetails = [
  {
    ...
    description:
      'Lorem ipsum dolor sit amet, conse ctetur adipiscing elit, sed do eiu smod tempor in cididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut. Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet.',
              ...
              <div className="testimonial-slider-wrapper position-relative mt-3">
                <div className="swiper testimonial-slider">
                  <div className="swiper-wrapper position-relative">
                    <CustomSwiper
                      navigationNext={'.testimonials-button-next'}
                      navigationPrev={'.testimonials-button-prev'}
                      noOfSlidesPerView={3}
                      isBreakPoint={true}
                            ...
                            <div className="testimonial-slider-box3">
                              <div className="testimonials-box">
                                ...
                                <p className="testi-user-info text-center">
                                  {details.name} <span className="d-block">{details.designation}</span>
                                </p>
                              </div>
                            </div>
                          </div>
