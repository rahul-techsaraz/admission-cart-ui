  ...
  return (
    <>
      ...
      <div className="clg-location-infograybx">
        <p>
          IIT Chennai University admission for 2023 is currently open. The university is accepting applications through
          its official website. Interested candidates can apply online as well as visit the campus to apply in the
          offline mode.{' '}
        </p>
