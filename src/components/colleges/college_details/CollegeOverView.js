    ...
    <>
        ...
        <div className="whatsNew-slider-wrapper position-relative mt-4 mb-5">
          <div className="swiper whatsNew-slider swiper-initialized swiper-horizontal swiper-backface-hidden">
            <div
              ...
              id="swiper-wrapper-37bc362fb3516451"
              aria-live="polite"
              style="transition-duration: 0ms; transform: translate3d(-554px, 0px, 0px); transition-delay: 0ms;"
            >
              <CustomSwiper noOfSlidesPerView={1} isBreakPoint={false}>
                <swiper-slide>
                  <div
                    ...
                    style="width: 262px; margin-right: 15px;"
                  >
                    <div className="whatsNew-inner-box">
                      <p className="whatsNew-date">October 6, 2023 10:09 AM</p>
                      <p className="whatsNew-para">
          ...
          <div
            className="swiper-button-prev whatsNew-button-prev"
            tabindex="0"
            role="button"
            aria-label="Previous slide"
            aria-controls="swiper-wrapper-37bc362fb3516451"
          >
            <img src={arrowLeftIcon} alt="" />
          </div>
          <div
            className="swiper-button-next whatsNew-button-next"
            tabindex="0"
            role="button"
      ...
      <div className="course-details-left-innerBox mb-5 text-center">
        ...
        <p className="imgText-para">
          It is an engineering and technology school in Chennai (formerly Madras) in southern India. Recognized as an
          Institute of National Importance by the Government of India, it is regarded as one of the finest engineering
          institutions in India. Founded in 1959...
        </p>
