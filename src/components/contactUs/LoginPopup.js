...
import { toggelAfterLoginModel, toggelIsLoginPopup, toggelIsSignupPopup, toggelLoginModel, updateauthenticateUser } from '../../features/commonSlice'
        ...
        <div className="login-popup-main-container">
            <div className="right-container">
                <div className="login-popup-form-close-btn-container">
                    <button id="login-popup-close-btn-btn" onClick={()=>dispatch(toggelIsLoginPopup({flag:false}))}>X</button>
                </div>
                ...
                <div className="login-popup-form-div">
                    <div className="loin-popup-form-phone-container">
                        <input type="text" className="login-popup-form-number-input i" id="country-code1" value={'+91'} readOnly/>
                        <input type="tel" className="login-popup-form-number-input-area i" id="phone1" placeholder="Mobile No." required onChange={(e)=>setLoginPhone(e.target.value)}/>
                    </div>
                
                    <div className="popup-login-form-password-container" id="password-container1">
                        <input type={isEye ? 'password' : 'text'} className="login-popup-form-password-form-input" id="password" placeholder="Password" required onChange={(e)=>setLoginPassword(e.target.value)}/>
                    ...
                    <button className="popup-login-form-btn-btn" onClick={()=>handleLogin()}>Login</button>
                    
                    <p className="popup-login-form-full-down-text">New to Admission Cart? <span className="popup-login-form-text" onClick={toggelToSignupPopup}>Signup</span></p>
                </div>
            </div>
        </div>
    </div>
