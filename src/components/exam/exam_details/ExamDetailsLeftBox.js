...
export default function ExamDetailsLeftBox() {
  ...
  const getAllExamByCategory = () => {
    const data = allExamData.filter(
      (v) =>
        v?.category_name === examDetailsById?.examBasicDetails?.category_name &&
        v?.exam_name !== examDetailsById?.examBasicDetails?.exam_name
    );
    return data;
  };
  const examDescriptionTabSetting = () => {
    ...
    const data = Object.keys(examDetailsById?.descriptionDetails)
      .filter((v) => {
        return [
      ...
      <div id="exam_details_leftBox" className="exam-details-leftBox">
        ...
        <div className="exam-details-left-innerpara mb-5 ps-5">
          <p className="exam-details-para1">
            {examDetailsById?.descriptionDetails?.exam_description.length > 300 && readmore.exam_description === false
              ? `${examDetailsById?.descriptionDetails?.exam_description.slice(0, 300)}...`
              : examDetailsById?.descriptionDetails?.exam_description}
          </p>
        ...
        <div className="exam-details-left-innerpara mb-5 ps-tick85">
          <p className="exam-details-para1">
            ...
            readmore.exam_conducting_body_description === false
              ? `${examDetailsById?.descriptionDetails?.exam_conducting_body_description.slice(0, 300)}...`
              : examDetailsById?.descriptionDetails?.exam_conducting_body_description}
          </p>
          {examDetailsById?.descriptionDetails?.exam_conducting_body_description.length > 300 && (
            <div className="text-start mt-5">
              <Link
        ...
        <div className="similar-exam-ylw-box yellow-bg py-5">
          ...
          <div className="d-flex justify-content-center flex-wrap gap-4">
            {examDetailsById?.examBasicDetails?.category_name &&
        ...
        <div className="similar-exam-bottom-contentbox text-center mt-5">
          ...
          <p className="similar-exam-bottom-contentbox-para1 mb-5">
            {examDetailsById?.descriptionDetails?.exam_important_dates_description.length > 300 &&
            readmore.exam_important_dates_description === false
              ? `${examDetailsById?.descriptionDetails?.exam_important_dates_description.slice(0, 300)}...`
              : examDetailsById?.descriptionDetails?.exam_important_dates_description}
          </p>
          ...
          <p className="similar-exam-bottom-contentbox-para2">
            {examDetailsById?.descriptionDetails?.exam_session_description.length > 300 &&
            readmore.exam_important_dates_description === false
              ? `${examDetailsById?.descriptionDetails?.exam_session_description.slice(0, 300)}...`
              : examDetailsById?.descriptionDetails?.exam_session_description}
          </p>
        </div>
          ...
          <div className="d-flex justify-content-around align-items-center">
            <div className="col-12 col-md-5 mt-4">
              <h1 className="exam-center-calenderTxt text-center">
                {`${examDetailsById?.examBasicDetails?.exam_name} ${examDetailsById?.examBasicDetails?.exam_year} Exam Dates`}{' '}
                <span>{`${examDetailsById?.examDetails?.session_name} ( ${examDetailsById?.examBasicDetails?.exam_start_date} )`}</span>
              </h1>
            </div>
          </div>
        </div>
        ...
        <div className="counselling-date-box">
          ...
          <p className="counselling-date-box-para">
            {examDetailsById?.descriptionDetails?.exam_counselling_description}
          </p>
          <div className="tobe-announce-bx yellow-bg">
            <p className="text-center">
              {examDetailsById?.examDetails?.counselling_dates == ''
                ? 'To Be Announced'
                : examDetailsById?.examDetails?.counselling_dates}
            </p>
          </div>
        ...
        <div className="exam-details-left-innerpara mb-5 ps-tick85">
          <p className="exam-details-para1">
            ...
            readmore.exam_application_form_description === false
              ? `${examDetailsById?.descriptionDetails?.exam_application_form_description.slice(0, 300)}...`
              : examDetailsById?.descriptionDetails?.exam_application_form_description}
          </p>
          {examDetailsById?.descriptionDetails?.exam_application_form_description.length > 300 && (
            <div className="text-start mt-5">
              <Link
                ...
                <div className="col-md-9">
                  ...
                  <p className="exam-registration-infopara">
                    ...
                    readmore.apllication_form_step1_description === false
                      ? `${examDetailsById?.descriptionDetails?.apllication_form_step1_description.slice(0, 300)}...`
                      : examDetailsById?.descriptionDetails?.apllication_form_step1_description}
                  </p>
                  {examDetailsById?.descriptionDetails?.apllication_form_step1_description.length > 300 && (
                    <Link
                      className="course-details-readmore-btn btn"
                ...
                <div className="col-md-9">
                  ...
                  <p className="exam-registration-infopara">
                    ...
                    readmore.apllication_form_step2_description === false
                      ? `${examDetailsById?.descriptionDetails?.apllication_form_step2_description.slice(0, 300)}...`
                      : examDetailsById?.descriptionDetails?.apllication_form_step2_description}
                  </p>
                  {examDetailsById?.descriptionDetails?.apllication_form_step2_description.length > 300 && (
                    <Link
                      className="course-details-readmore-btn btn"
                ...
                <div className="col-md-9">
                  ...
                  <p className="exam-registration-infopara">
                    ...
                    readmore.apllication_form_step3_description === false
                      ? `${examDetailsById?.descriptionDetails?.apllication_form_step3_description.slice(0, 300)}...`
                      : examDetailsById?.descriptionDetails?.apllication_form_step3_description}
                  </p>
                  {examDetailsById?.descriptionDetails?.apllication_form_step3_description.length > 300 && (
                    <Link
                      className="course-details-readmore-btn btn"
            ...
            <div className="row">
              <div className="col-12 col-lg-5 pe-0">
                <div className="nav flex-column nav-pills nav-pills-custom">
                  {Object.keys(examDetailsById).length > 0 &&
