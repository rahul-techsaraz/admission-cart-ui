...
export default function ExamHighlights({ examDetailsById }) {
  return (
    <div className="exam-details-hightlisghts-sec mt-5">
        ...
        <table className="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                {examDetailsById?.highlightsDetails
                  ?.map((conductingBody) => conductingBody.conducting_body)
                  .join(' / ')}
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                {examDetailsById?.highlightsDetails?.map((examFrequency) => examFrequency.exam_frequency).join(' ')}
              </td>
            </tr>
            <tr>
              <td>Model of Exam</td>
              <td>
                <ul>
                  {examDetailsById?.highlightsDetails?.map((model) => (
                    <li>{model.model_of_exam}</li>
                  ))}
            ...
            <tr>
              ...
              <td>
                <ul>
                  {examDetailsById?.highlightsDetails?.map((examDuration) => (
                    <li>{examDuration.exam_duration}</li>
                  ))}
            ...
            <tr>
              ...
              <td>
                <ul>
                  {examDetailsById?.highlightsDetails?.map((marks) => (
                    <li>{marks.paper_marks}</li>
                  ))}
            ...
            <tr>
              ...
              <td>
                <ul>
                  {examDetailsById?.highlightsDetails?.map((scheme) => (
                    <li>{scheme.marking_scheme}</li>
                  ))}
      ...
      <div className="text-start mt-5">{/* <Link className="course-details-readmore-btn btn">Read More</Link> */}</div>
    </div>
  );
}
