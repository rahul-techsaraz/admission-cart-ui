...
const ExamMockList = () => {
  ...
  <tr>
    <th className='exam_mock_list-table_th' colspan="3">{`${examDetailsById?.examBasicDetails?.exam_name} ${examDetailsById?.examBasicDetails?.exam_year} Mock Test PDF`}</th>
  </tr>
  ...
  <tr>
  <th className='exam_mock_list-table_thh' colspan="2">{`Download ${examDetailsById?.examBasicDetails?.exam_name} ${examDetailsById?.examBasicDetails?.exam_year} Mock test-5`}</th>
...
<div className='neet_question_paper'>
  ...
  <p className='neet_question_paper_p'>The Previous year question papers of the last 7 years for the NEET exam have been given below</p>
  <table className='exam_mock_list-table'>
  <tr>
