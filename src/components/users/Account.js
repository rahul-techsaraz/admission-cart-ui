          ...
          <div className="side-bar">
            ...
            <div className="left-box">
              ...
              <div className="notification-box">
                ...
                <p className="noti-p">
                  Never miss important reminders & notifications about the latest education news and your admission
                  journey status
                </p>
              ...
              <div className="issu-box">
                ...
                <div className="submit-button-box">
                  <div className="submit-button from-center" onClick={() => handleSubmit()}>
                    Submit
                  </div>
                </div>
              </div>
