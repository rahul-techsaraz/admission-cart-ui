...
export default function Document() {
    ...
    const afterFileUpload = async ()=>{
      try{
        ...
        const jsonData = await dispatch(saveUserDocument({
    ...
    <>
        ...
        <div className="left-box">
            ...
            <div className="tabset">
                ...
                <label for="tab1" onClick={(e)=>handleTabClick(e)}>Basic Documents</label>
                {/* <!-- Tab 2 --> */}
                <input type="radio" name="tabset" id="tab2" aria-controls="rauchbier"/>
                <label for="tab2" onClick={(e)=>handleTabClick(e)}>Admission Proof</label>
