              ...
              <div className="all-collage">
                ...
                <div className="img-colg-name">
                  <div className="img-colg-name-child">
                    ...
                    <div className="colg-name">
                      <h4>
                        AP ICET 2024 అప్లికేషన్‌‌ను ఫిల్ చేయడానికి (Documents to AP ICET 2024 application) ఏ
                        డాక్యుమెంట్లు అవసరం?
                      </h4>
                    </div>
                  </div>
                ...
                <div className="img-colg-name">
                  <div className="img-colg-name-child">
                    ...
                    <div className="colg-name">
                      <h4>
                        AP ICET 2024 Application Form: ఏపీ ఐసెట్ 2024 అప్లికేషన్ ఫార్మ్‌ కరెక్షన్ విధానం, ముఖ్యమైన
                        తేదీలు
                      </h4>
                    </div>
                  </div>
                ...
                <div className="img-colg-name">
                  <div className="img-colg-name-child">
                    ...
                    <div className="colg-name">
                      <h4>
                        ACPC Gujarat MCA Admission 2024: Dates, Application Form, Eligibility, Merit List, Choice
                        Filling, Seat Allotment
                      </h4>
                    </div>
                  </div>
                </div>
                ...
                <div className="img-colg-name">
                  <div className="img-colg-name-child">
                    ...
                    <div className="colg-name">
                      <h4>
                        Documents Required for AP ICET 2024 Application Form - Photograph, Signature, Payment Details
                      </h4>
                    </div>
                  </div>
                </div>
                ...
                <div className="img-colg-name">
                  <div className="img-colg-name-child">
                    ...
                    <div className="colg-name">
                      <h4>
                        AP ICET 2024 Application Form Correction - Direct Link, Dates, Categories, Detailed Instructions
                      </h4>
                    </div>
                  </div>
                </div>
                ...
                <div className="img-colg-name">
                  <div className="img-colg-name-child">
                    ...
                    <div className="colg-name">
                      <h4>
                        MBA Colleges in India with Low Fees - List of B-Schools Offering an Affordable MBA Degree in
                        India
                      </h4>
                    </div>
                  </div>
