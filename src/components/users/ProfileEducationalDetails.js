...
export default function ProfileEducationalDetails() {
    ...
    const handleSave = async ()=>{
        try{
            if(dataCheck()){
                ...
                const response = await dispatch(saveUserEducationalDetails({
    ...
    const handleDelete = async (i)=>{
        try{
            ...
            const response = await dispatch(deleteUserEducationalDetails({
                url : constants.apiEndPoint.USER_EDUCATIONAL_QUALIFICATION_UPDATE,
            ...
            <div className="education-details">
                <div className="education-details-all-text">
                    ...
                    <div className="educationl-details-wraper">
                        ...
                        divlable="Board"
                        inputLabel="Board"
                        onChange={(e)=>dispatch(updateQualification({qualificationInfo:{...userQualification, board_name:e.target.value}}))}
                        style={{fontWeight:"600"}}
                        ...
                        divlable="School"
                        inputLabel="School"
                        onChange={(e)=>dispatch(updateQualification({qualificationInfo:{...userQualification, school_name:e.target.value}}))}
                        style={{fontWeight:"600"}}
                        ...
                        onChange={(e)=>dispatch(updateQualification({qualificationInfo:{...userQualification, passing_year:e.target.value}}))}
                        style={{fontWeight:"600"}}
                        ...
                        onChange={(e)=>dispatch(updateQualification({qualificationInfo:{...userQualification, marks_type:e.target.value}}))}
                        style={{fontWeight:"600"}}
                        ...
                        onChange={(e)=>dispatch(updateQualification({qualificationInfo:{...userQualification, marks_percentage:e.target.value}}))}
                        style={{fontWeight:"600"}}
                        ...
                        divlable="Stream"
                        inputLabel="Stream"
                        onChange={(e)=>dispatch(updateQualification({qualificationInfo:{...userQualification, stream:e.target.value}}))}
                        style={{fontWeight:"600"}}
                ...
                <div className="besic-detials-all-text-hide-button-parent">
                    ...
                    <button className="besic-detials-button-save" disabled={disable} onClick={(e)=>handleSaveOrUpdate(e)} style={disable ? {backgroundColor:"lightgray"} : {}}>{toggleButton ? 'SAVE' : 'UPDATE'}</button> 
                </div>
            </div>
        </>
        }
