...
export default function UserDashBoardBanner() {
  ...
  const calculateWidth = () => {
    if (
      isComplete.basicDetails &&
      isComplete.educationalDetails &&
      isComplete.preferences &&
      isComplete.recomendation &&
      isComplete.preferences
    ) {
      return '99%';
    } else if (
        ...
        <div className="contain">
          <div className="steps">
            <div className="steps-span-p">
              <span
                className={
                  isComplete.basicDetails && isComplete.educationalDetails && isComplete.preferences
                    ? 'circle active'
                    : 'circle'
                }
              >
            ...
            <div className="steps-span-p">
              <span className={isComplete.recomendation ? 'circle active' : 'circle'}>
            ...
            <div className="steps-span-p">
              <span className={isComplete.shortlisting ? 'circle active' : 'circle'}>
                <img src={constants.images.users.shortlist} alt="shortlist" />
              </span>
            ...
            <div className="steps-span-p">
              <span className={isComplete.documentUploaded ? 'circle active' : 'circle'}>
