            ...
            <div className="col-lg-7">
              <div className="position-relative">
                ...
                <p className="imgText-para">
                  It was founded under the aegis of Girnarsoft Education Services Pvt Ltd. (GESPL) to institutionalize
                  students’ counseling in India. Between its inception in 2015 and 2021, Collegedekho.com has counselled
                  over two million students. Headquartered in Gurgaon, Haryana, and with satellite offices in Delhi,
                  Chandigarh, Bangalore, Chennai, Hyderabad, Kolkata, Pune, Mumbai etc,
                </p>
                <Link className="theme-btn black-btn" to={'about'} target="_blank">
                  View More
                </Link>
