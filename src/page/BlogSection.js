                    ...
                    <div className="blog-col">
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-md-6">
                                ...
                                <p className="latest-blog-userdetails d-flex align-items-center justify-content-between"><img src={blogImage2} className="me-3" alt="" /><span className="blog-user-name me-auto">Lorem ipsum</span> <span className="latest-blogpost-date">02 Oct 2023</span></p>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-md-6">
                    ...
                    <div className="blog-col upcoming-blog-col">
                        ...
                        <div className="row mb-3">
                            <div className="col-4">
                                <div className="upcoming-blog-datesec d-flex flex-column text-center">
                                    <span className="upcoming-blog-date position-relative">
                                        <p>20<span className="d-block">Oct</span></p>
                                    </span>
                                    <span className="upcoming-blog-year">
                                        2023
                                    </span>
                                </div>
                            </div>
                            <div className="col-8">
                                ...
                                <p className="upcoming-blog-para">Bimply dummy text of the printing and typesetting istryrem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer.when an unknown printer took a galley of type and scrambled…</p>
