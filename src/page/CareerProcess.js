...
const CareerProcess = () => {
    return(
        ...
        <div className="container">
            <ul className="process-list d-flex">
                <li>
                    ...
                    <div className="px-2">
                        ...
                        <p className="process-para">Take the intuitive technology-based Career Compass test to assess the right career choice for you.</p>
                    </div>
                </li>
                <li>
                    <div className="dashed-border position-relative">
