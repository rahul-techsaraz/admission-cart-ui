    ...
    return(
        ...
        <div className="choice-place-innersection d-flex">
            <div className="choice-place-col2 green-bg">
               ...
               <p>Too many choices can be daunting! Analyse your aptitude, capabilities, personality and interests with our scientific psychometric tool, and get advised on the best career options for you. It can also derive whether or not you are suitable for a particular career or role type.</p>
               <Link className="theme-btn black-btn" to={"/courses_list"}>Explore Courses</Link>
            </div>
