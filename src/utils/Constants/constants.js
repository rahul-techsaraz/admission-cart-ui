...
const constants = {
  apiEndPoint: {
    ...
    USER_DETAILS_GET_ALL_USER_TO_VERIFY:
      'https://techsaraz.in/admission-cart/api/user.php?requestType=userDetails&email=',
    USER_EDUCATIONAL_QUALIFICATION_TO_VERIFY:
      'https://techsaraz.in/admission-cart/api/user.php?requestType=educationalQualification&email=',
    ...
    USER_SORTLIST_GET_ALL:
      'https://techsaraz.in//admission-cart/api/user.php?requestType=userShortListedCollege&email=',
  ...
  topColleges: ['IIT Kharagpur', 'IIT Delhi', 'IIT Madras', 'IIT Roorkee', 'IIT Kanpur'],
  ...
  images: {
    users: {
      ...
      noDataImg: noDataImg,
      buLogo: buLogo,
      callNowBanner: callNowBanner,
      reward: reward,
      imgBannerUpload: imgBannerUpload,
      rankUpto1000: rankUpto1000,
      lowRank: lowRank,
      cutOffScore: cutOffScore,
      goodScore: goodScore,
      topMbaMumbai: topMbaMumbai,
      topMbaPune: topMbaPune,
      normalisation: normalisation,
      cutoffJBIMS: cutoffJBIMS,
      cutoffPUMBA: cutoffPUMBA,
      passingMarks: passingMarks,
      formCorrection: formCorrection,
      mcaGujarat: mcaGujarat,
      mahbacetai: mahbacetai,
      catTamilNadu: catTamilNadu,
      lowFees: lowFees,
      connectUs: connectUs,
    },
    PsychometricTest: {
      PsychometricTestimg1: PsychometricTestimg1,
      PsychometricTestimg2: PsychometricTestimg2,
      PsychometricTestimg3: PsychometricTestimg3,
      timeLineImg1: timeLineImg1,
      timeLineImg2: timeLineImg2,
      timeLineImg3: timeLineImg3,
      timeLineImg4: timeLineImg4,
      testiUserImg1: testiUserImg1,
      testiUserImg2: testiUserImg2,
      testiUserImg3: testiUserImg3,
  ...
  userPreferencesStream: ['Select', 'Science', 'Commerce', 'Arts'],
  userPreferencesLevel: ['Select', '10th Standard', 'PUC', 'Diploma', 'Graduation', 'Post Graduation', 'Masters'],
  state: [
    'Select',
